...
public class MutualFundTransactionHistoryService {
	...
	public void insertTransaction(Long userId, Long mutualFundsId, String type, Double price, Integer unit,
		...
		transactionHistoryRepository.insertTransaction(userId, mutualFundsId, type, price, unit, transactionWallet);
	}
	...
	public List<MutualFundTransactionHistoryEntity> getTransactionsByType(String type) {
		return transactionHistoryRepository.findByType(type);
	}
}
