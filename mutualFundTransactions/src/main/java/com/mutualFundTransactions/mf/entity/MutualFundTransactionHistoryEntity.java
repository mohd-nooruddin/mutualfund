...
public class MutualFundTransactionHistoryEntity {
	...
	@Column(name = "transaction_wallet")
	...
	public double getTransactionWallet() {
		return transactionWallet;
	}

	public void setTransactionWallet(double transactionWallet) {
	...
	public MutualFundTransactionHistoryEntity(Long id, Long userId, Long mutualFundsId, String type, Double price,
			Integer unit, Date transactionDate, double transactionWallet) {
		super();
		this.id = id;
		this.userId = userId;
		this.mutualFundsId = mutualFundsId;
